        ...
        <div class="flex bg-gray-200 px-4 py-10 rounded-lg">
            <div class="mx-auto">
                <div class="relative h-20 w-20">
                    <!-- Image element with ID for preview -->
                    <img id="previewImage" class="h-20 w-20 rounded-full object-cover" src="{{ asset('uploads/' . $user->photo) }}" alt="">
                    <!-- Button to trigger file input -->
                    <button onclick="document.getElementById('photo').click()"><svg class="absolute right-0 bottom-0 h-7 w-7" width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
