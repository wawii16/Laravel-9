  ...
  <div class="container mx-auto">
    ...
    <div class="flex flex-wrap">
      ...
      <div class="w-full lg:w-1/3 flex items-center justify-center py-10">
        <form action="{{ url('registration_post') }}" method="post" class="mx-8 w-full">
          @csrf
          <div class="mb-5">
            <h1 class="text-5xl font-medium">Sign Up</h1>
            <p class="mt-4"></p>
            Already have account? <span><a href="/login" class="text-blue-600 hover:underline dark:text-blue-500">Login</a>
            </span>
          </div>
          <div class="mb-5">
            @if ($errors->any())
