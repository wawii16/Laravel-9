...
<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    ...
    <form action="{{ route('brands.store') }}" class="max-w-sm mx-auto" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            ...
            <input name="birth_date" value="{{ old('birth_date') }}" type="date" id="birth_date" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="" required />
        </div>
